...
所以放在反代后**必须**正确设置 trust proxy,并让网关重写转发头。详见 [受信任代理](/security/trust-proxy)。
...
|---|---|
| **限流** | 掐住高频尝试,降速 |
| [scrypt 高成本](/security/password-hashing) | 即便慢速撞库,每次猜测也极贵 |
| [防枚举等时](/security/password-hashing#防枚举) | 不让攻击者先筛出有效账号 |
| [PoW 验证](/security/captcha-pow) | 给登录/注册叠加机器成本 |
| [封禁](#) | 对确认的恶意设备直接拉黑 |
...
| 资源请求高频 | 单设备 5min 内 ≥ 30 次资源类请求 | 异常资源请求频率 | 24h |
